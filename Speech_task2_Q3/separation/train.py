...
if __name__ == "__main__":
    ...
    # # Create an instance of the Separation class
    # separator = Separation(
    #     modules=hparams["modules"],
    #     opt_class=hparams["optimizer"],
    #     hparams=hparams,
    ...
    # model_state = torch.load(os.path.join(hparams["output_folder"], "trained_separator.pth"))
    ...
    # # Now you can use the `separator` instance for inference or further training
